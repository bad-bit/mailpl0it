...
def main():
	...
	parser.add_argument("-l", "--list", help="Comma seperated words to hunt on exploit-db. Example: mailpl0it.py -l \"LPR, RCE\" ", required=True, dest='wordlist', type=str)
	...
	parser.add_argument("-m", "--email", help="Your email-id to receive notification emails.", required=True, dest='email', type=str)
